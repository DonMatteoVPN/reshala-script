...
# ============================================================ #
# ==      ИНСТРУМЕНТ «РЕШАЛА» v0.37 dev - HARD ALIGNMENT     ==
# ============================================================ #
...
display_header() {
    ...
    local max_label_width=11 # Жестко задаем по самому длинному слову "Оперативка" или "Веб-сервер"
    ...
    elif [[ "$UPDATE_CHECK_STATUS" != "OK" ]]; then echo -e "${C_RED}║ ⚠️ Ошибка проверки обновлений (см. лог)${C_RESET}"; fi
